...
export default function LogsPage() {
  const router = useRouter()       // สำหรับ "เปลี่ยน" URL
  const pathname = usePathname()   // สำหรับ "อ่าน" Path ปัจจุบัน (เช่น /logs)
  const searchParams = useSearchParams() // สำหรับ "อ่าน" ?page=...
